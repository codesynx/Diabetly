...
// Hook for textarea resize
function useTextareaResize(value: string, minRows = 1) {
  ...
  useEffect(() => {
    ...
    const newHeight = Math.max(
      ...
      minRows * 24 // Assume 24px per row as a baseline
    );
...
export { ChatInput, ChatInputTextArea, ChatInputSubmit, useTextareaResize }; 